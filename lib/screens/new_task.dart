...
import 'package:task_manager/service/firebase_service.dart';
...
class _NewTaskScreenState extends State<NewTaskScreen> {
  ...
  Future<void> _createTask() async {
    ...
    try {
      ...
      final String taskId = await _firebaseService.addTask(newTask);
      ...
      // Lên lịch nhắc nhở với NotificationService
      // final notificationService = NotificationService();
      // await notificationService.scheduleTaskReminder(
      //   taskId, // ID của task từ Firestore
      //   newTask.title, // Tiêu đề của task
      //   newTask.endTime, // Deadline của task
      // );
    } catch (error) {
      if (mounted) {
